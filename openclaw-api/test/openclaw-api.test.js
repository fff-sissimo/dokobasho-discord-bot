...
const { buildAutonomyRequestAuditRecord, buildRequestAuditRecord, createServer, writeRequestAudit } = require("../src/server");
const {
  buildAgentPrompt,
  buildAutonomyPrompt,
          ...
          n8n_workflow_requests: [
            {
              ...
              input: { purpose: "直近の流れ確認", max_channels: 20, messages_per_channel: 5, include_threads: true },
            },
            {
              id: "thread_1",
    ...
    fetchImpl: async (url) => {
      ...
      return {
        ...
        text: async () => JSON.stringify({
          ...
          results: [{ id: "read_1", workflow_key: "discord.server_read", operation: "discord.fetch_recent_summary", status: "ok", summary: "要約" }],
        }),
      };
    },
  });
